...
export const LeaveAReveiw: React.FC<{submitReview: any}> = (props) => {
        ...
        <div className="dropdown" style={{ cursor: 'pointer' }}>
            ...
            {displayInput &&
               <form method='POST' action='#'>
                    ...
                    <div>
                        <button type="button" onClick={() => props.submitReview(starInput, reviewDescription)} className="btn btn-primary mt-3">Submit</button>
                    </div>
