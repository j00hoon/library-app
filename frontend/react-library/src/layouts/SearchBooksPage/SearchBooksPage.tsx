            ...
            <div className='container'>
              ...
              <div className='row mt-5'>
                ...
                <div className='col-4'>
                    <div className='dropdown'>
                        <button className='btn btn-secondary dropdown-toggle' type='button'
                            id='dropdownMenuButton1' data-bs-toggle='dropdown' aria-expande='false'>
                            {categorySelection}
                        </button>
                ...
                {totalAmountOfBooks > 0 ? 
                    <>
                        <div className='mt-3'>
                            <h5>Results : ({totalAmountOfBooks})</h5>
                        </div>
                        <p>
                        ...
                        <div className='m-5'>
                            <h3>
                                Can't find the books you are looking for?
                            </h3>
