...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook:any }> = (props, key) => {
    ...
    async function increaseQuantity() {
        ...
        if (!quantityUpdateResponse.ok) {
            throw new Error("Something went wrong increaseQuantity");
        }
    ...
    return (
        <div className='card mt-3 shadow p-3 mb-3 bg-body rounded'>
            <div className='row g-0'>
                ...
                <button className='m-1 btn btn-md main-color text-white' onClick={increaseQuantity}>Add</button>
                <button className='m-1 btn btn-md btn-warning' onClick={decreaseQuantity}>Decrease</button>
